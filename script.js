...
let drawCells = () => {
    canvas.selectAll('rect')
          ...
          .attr('fill', (item) => {
              ...
              if(variance <= -2.5){
                return '#0c2461' //dark sapphire
              } else if (variance <= -2){
                return '#1e3799' //yue guang lan blue
              } else if (variance <= -1){
                return '#4a69bd' //azraq blue
              } else if (variance <= -0.5){
                return '#6a89cc' //livid
              } else if (variance <= 0){
                return '#f8c291' //melon melody
              } else if (variance <= 0.5){
                return '#e55039' //mandarin red
              } else if (variance <= 1){
                return '#eb2f06' //tomato red
              } else {
                return '#b71540' //jalapeno red
              }
          })
          .attr('data-year', (item) => {
              return item['year']
